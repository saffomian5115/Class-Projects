...
const AddJob = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.reminderEnabled && formData.reminderDate) {
    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="mb-8">
          ...
          <h1 className="font-display text-3xl font-bold">Add New Application</h1>
          <p className="text-dark-400 mt-1">Track a new job application</p>
        </div>
